  ...
  async function login() {
    ...
    try {
      let result = await fetch(
        "https://splitwise-apiv1.herokuapp.com/user/login",
        {
          method: "POST",
          headers: {
      ...
      if (result.error == null) {
        ...
        let groups = await fetch(
          `https://splitwise-apiv1.herokuapp.com/user/groups/${user.id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
        ...
        <div className="m-login">
          ...
          <div className="login-s">
            <p className="login-head">
              Split<span style={{ color: "#1CC39D" }}>Wiser</span>
            </p>
